...
func RunTask(task Task) {
	utility.LogMessage(fmt.Sprintf("Starting Worker Node for stage: %d => ID:%d, operation: %v, inputfile: %v, outputfile: %v", task.Stage, task.TASK_ID, task.Operation, task.InputHydfsFile, task.OutputHydfsFile))
